...
public class Links {
  ...
  **/
  ...
  @ApiModelProperty(example = "https://api.zapier.com/v2/apps?offset=20&limit=10", value = "The URL of the next page of paginated results.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://api.zapier.com/v2/apps?offset=0&limit=10", value = "The URL of the previous page of paginated results.")
