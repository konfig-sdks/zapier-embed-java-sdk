 ...
 */
@ApiModel(description = "The meta object returned in paginated response bodies.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Meta {
  ...
  **/
  ...
  @ApiModelProperty(example = "10", value = "The limit value used in the request.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The offset value used in the request.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "133", value = "The total number of objects in the collection represented by the endpoint.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(limit, offset, count, additionalProperties);
  }
